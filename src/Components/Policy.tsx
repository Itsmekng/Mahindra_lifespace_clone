      ...
      <nav className="w-full h-14 flex items-center justify-between px-8 md:px-24 py-12 md:py-8 ">
        ...
        <h2 className="text-5xl lg:text-6xl font-semibold mb-4 text-center text-gray-700 mt-8">
          ...
          <div className="px-8 md:px-24">
            ...
            <p>We are an authorized channel partner of Mahindra Blossom by Mahindra Lifespaces.</p>
            <p>We value your privacy and are committed to protecting your personal information.</p>
            <p>We collect limited data—such as your name, contact details, and property preferences—to provide personalized real estate solutions and improve our services.</p>
            <p>Your data may be shared with trusted partners (like builders, legal advisors, or financial institutions) only for service-related purposes. We never sell or misuse your information.</p>
            <p>All data is stored securely and used in compliance with applicable privacy laws. By engaging with us, you consent to our data practices. For any queries or to manage your data, please contact us at yasir.mg@gmail.com</p>


            <h2 className="mb-2 mt-6 font-semibold text-xl">2. Personal Data We Collect</h2>
            <p>We collect the minimum information necessary to operate our website, communicate with visitors, and deliver our services. <br />Data you provide directly:</p>
            <p>• Name</p>
            <p>• Email address</p>
            <p>• Phone number</p>

            <h2 className="mb-2 mt-6 font-semibold text-xl">4. Contact Us</h2>
            <p>For questions, data requests, or concerns related to privacy, contact:yasir.mg@gmail.com</p>

            <h2 className="mb-2 mt-6 font-semibold text-xl">3. How We Collect Personal Data</h2>
            <p>We collect information through:</p>
            <p>• Contact forms</p>
            <p>• Email communication</p>
            <p>• Basic analytics services</p>
            <p>• Advertising performance and measurement tools</p>
          </div>

          <div className="bg-red-500 pb-10 pt-6 mt-24">
